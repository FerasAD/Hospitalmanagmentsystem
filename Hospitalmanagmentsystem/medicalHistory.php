...
<body>
    ...
    echo '<br><br><br><br><br><br><br><h1>Medical History</h1>';
    echo '<table>';
    echo '<br><br><tr><th>Previous Health Issue</th><td>'.$row['PreHealthIssue'].'</td></tr>';
    echo '<tr><th>Previous Medication taken</th><td>'.$row['PreMedication'].'</td></tr>';
    echo '<tr><th>Date of Medication</th><td>'.$row['DateSE'].'</td></tr>';
    echo '</table>';
